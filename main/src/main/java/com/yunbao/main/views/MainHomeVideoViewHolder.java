...
public class MainHomeVideoViewHolder extends AbsMainHomeChildViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public void init() {
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<VideoBean>() {
            ...
            public List<VideoBean> processData(String[] info) {
                videoDatas = JSON.parseArray(Arrays.toString(info), VideoBean.class);
                return videoDatas;
            }
    ...
    public void onItemClick(VideoBean bean, int position) {
        ...
        if (videoDatas != null) {
            ...
            intent.putExtra("videoPath", videoDatas.get(position).getHref());
            intent.putExtra("imagePath", videoDatas.get(position).getThumb());
            intent.putExtra("title", videoDatas.get(position).getTitle());
