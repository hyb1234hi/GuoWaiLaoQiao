...
public class RefreshView<T> extends FrameLayout implements View.OnClickListener {
    ...
    public void addHaderView(View layoutHader) {
        myHaderView.addView(layoutHader);
    }
    ...
    protected void onFinishInflate() {
        ...
        myHaderView = view.findViewById(R.id.myViewHader);
        ...
        mRefreshLayout.setRefreshHeader(new MaterialHeader(mContext).setShowBezierWave(false));
        //设置 Footer 为 球脉冲
        mRefreshLayout.setRefreshFooter(new BallPulseFooter(mContext).setSpinnerStyle(SpinnerStyle.Scale));
        mRefreshLayout.setOnMultiPurposeListener(new SimpleMultiPurposeListener() {
            @Override
            public void onStateChanged(@NonNull com.scwang.smartrefresh.layout.api.RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
            }
