...
public class TabButtonGroup extends LinearLayout implements View.OnClickListener {
    ...
    private onBackShear onBackShear;

    public void setOnBackShear(TabButtonGroup.onBackShear onBackShear) {
        this.onBackShear = onBackShear;
    }
    ...
    public void setVideomCurPosition(int Position) {
        indext = Position;
    }
