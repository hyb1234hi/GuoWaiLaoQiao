...
//    }
     ...
     * 获取付费视频
     */
    public static void GetMyBuyVideo(String toUid, int p, HttpCallback callback) {
        HttpClient.getInstance().get("User.GetMyBuyVideo", VideoHttpConsts.GET_HOME_VIDEO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("p", p)
                .execute(callback);
    }
     ...
     * 获取首页视频列表
     */
    public static void VideoGetVideoList(int p, String classify_id, HttpCallback callback) {
        HttpClient.getInstance().get("Video.GetVideoList", VideoHttpConsts.GET_HOME_VIDEO_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
